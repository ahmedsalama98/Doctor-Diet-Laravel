    ...
    <div class="container">
        ...
        <div class=" row align-items-center justify-content-center">
            <div class="col-md-10">
                ...
                <h1>{{__('site.create_new_food')}}</h1>

                <form action="{{ route('admin.foods.store') }}" action="" class="form-group" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                    {{-- name_ar --}}
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-10">
                            ...
                            <input  id="calories" name="calories"  type="number" class="form-select @error('calories') is-invalid @enderror">
                        </div>
                        @error('calories')
                        <div class="col-12 text-danger">
                            {{ $message }}
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-10">
                            ...
                            <select class="form-select @error('unit') is-invalid @enderror" aria-label="Default" name="unit">
                                <option selected value="gm">{{__('site.100_gm')}}</option>
                                <option value="cup">{{__('site.1_cup')}}</option>
                                <option value="one">{{__('site.1_one')}}</option>
