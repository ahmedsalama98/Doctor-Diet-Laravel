        ...
        <div class="card ">
                <div class="card-header">
                    ...
                    <div class="row justify-content-between align-self-center pb-16">
                                ...
                                <h2> {{ __('site.food_categories')}}</h2>
                                </div>




                                <div action="{{ route('admin.food_categories.index') }}" class="col-auto">
            ...
            <div class="card-body">
                <div class="table-responsive">
                        ...
                        <table class="table table-hover table-responsive p-8">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="cell">
                                        ...
                                        @if (Auth::user()->hasPermission('food_categories-update'))
                                        <a class="btn btn-primary " href="{{route('admin.food_categories.edit',$category->id)}}">{{ __('site.edit') }}</a>
                                        ...
                                        @if (Auth::user()->hasPermission('food_categories-delete'))


                                        <form class="d-inline-block" action="{{route('admin.food_categories.destroy',$category->id)}}" method="POST">
                                            @csrf
                                            @method('DELETE')
                      ...
                      <div class="row align-items-center justify-content-between align-content-center">
                          ...
                          <div class="col-auto">
                            @if (Auth::user()->hasPermission('food_categories-create'))
                            <a class="btn btn-success " href="{{ route('admin.food_categories.create') }}">{{ __('site.create_new_food_category')  }}</a>

                            @else

                            <button class="btn btn-success disabled" >{{ __('site.create_new_food_category')  }}</button>
