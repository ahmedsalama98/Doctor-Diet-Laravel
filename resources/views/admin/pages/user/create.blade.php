    ...
    <div class="container">
        ...
        <div class=" row align-items-center justify-content-center">
            <div class="col-md-6">
                ...
                <h1>{{__('site.create_new_user')}}</h1>

                <form action="{{ route('admin.users.store') }}" action="" class="form-group" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                    {{-- name --}}
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-10">
                            ...
                            <select class="form-select @error('gender') is-invalid @enderror" aria-label="Default" name="gender">
                                <option  value="0">{{__('site.male')}}</option>
                                <option value="1">{{__('site.female')}}</option>
                                <option value="">{{__('site.another_thing')}}</option>
                            </select>
                        </div>
                        @error('gender')
                        <div class="col-12 text-danger">
