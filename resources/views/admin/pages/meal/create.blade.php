    ...
    <div class="container">
        ...
        <div class=" row align-items-center justify-content-center">
            <div class="col-md-12">
                ...
                <h1>{{__('site.create_new_meal')}}</h1>

                <form action="{{ route('admin.meals.store') }}" action="" class="form-group" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                    {{-- name_ar --}}
                                ...
                                <div id="flush-collaps-{{  $category->id }}" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                    ...
                                    <table  class="table table-hoverd table-responsive p-8">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <th>  {{ $food->name}}</th>
                                                <th>  <button type="button" id="add_food_{{ $food->id}}" class="btn btn-success add_food" data-food_unit="{{ __('site.'.$food->unit) }}" data-food_name="{{ $food->name }}" data-food_id="{{ $food->id }}"> add</button></th>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
